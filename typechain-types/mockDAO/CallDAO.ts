...
export interface CallDAOInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "execute"
      | "nextProposalId"
...
export interface CallDAO extends BaseContract {
  connect(runner?: ContractRunner | null): CallDAO;
  waitForDeployment(): Promise<this>;

  interface: CallDAOInterface;
